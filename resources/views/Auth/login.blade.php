...
<body>
    <div class="flex flex-row">
        <div class="max-[1024px]:w-full w-3/5 h-screen">
            ...
            <div class="p-3 mt-10">
                <p class="text-center text-lg mb-6">Masuk Perpustakaan</p>
                ...
                <p class="text-center text-sm mt-12">Tidak mempunyai akun ? <a href="#" class="text-blue-600 hover:underline">Daftar disini</a></p>
            </div>
        </div>
